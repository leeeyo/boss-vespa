...
export default function AddProductPage() {
  ...
  const toggleCompatibility = (scooterId: string) => {
    setFormData(prev => ({
      ...prev,
      compatibility: prev.compatibility.includes(scooterId)
        ? prev.compatibility.filter(id => id !== scooterId)
        : [...prev.compatibility, scooterId]
    }))
  }
    ...
    <div className="min-h-screen pb-32 lg:pb-8">
      <div className="container mx-auto px-4 py-6 lg:py-8 text-white">
        ...
        <div className="mb-6 lg:mb-8">
          ...
          <p className="text-white/50 mt-2">Remplissez les informations pour créer un nouveau produit</p>
        </div>
