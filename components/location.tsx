...
export function Location() {
  return (
    <section id="contact" className="py-12 px-4 bg-linear-to-br from-slate-950 via-slate-900 to-gray-900 text-white">
      <div className="container mx-auto">
        <div className="text-center mb-8 space-y-2 overflow-visible">
          <h2 className="text-3xl md:text-4xl font-bold bg-linear-to-r from-amber-400 via-rose-400 to-sky-400 bg-clip-text text-transparent overflow-visible whitespace-normal wrap-break-words px-2 py-1">
            Notre Magasin
          </h2>
          <p className="text-base text-white/80 max-w-2xl mx-auto">
            Passez au showroom pour essayer les Vespas, sélectionner vos accessoires et finaliser votre projet avec notre équipe.
          </p>
        </div>
              ...
              <CardContent className="p-0 h-[250px]">
                <div className="relative h-full">
                  ...
                  <div className="absolute bottom-4 left-4 right-4 text-white">
                    <p className="text-xs uppercase tracking-[0.3em] text-white/80">Mahdia • TN</p>
                    <p className="text-xl font-semibold">Un showroom vivant et coloré</p>
                  </div>
                </div>
              </CardContent>
            </Card>
...
function InfoRow({ icon, title, content, gradient }: InfoRowProps) {
  return (
    <div className="flex items-start gap-3">
      <div
        className={`w-10 h-10 rounded-full bg-linear-to-br ${gradient} flex items-center justify-center shrink-0`}
      >
        {icon}
      </div>
      <div>
